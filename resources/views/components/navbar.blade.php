        ...
        >
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                ...
                >
                    ...
                    <li>
                        <a
                            class="{{ request()->is('galeri') ? 'text-emerald-700' : 'text-gray-700 hover:text-emerald-700' }} block py-2 px-3 transition-colors duration-300 transform md:mx-4 md:my-0"
                            href="/galeri"
                            >Galeri</a
                        >
                    </li>
