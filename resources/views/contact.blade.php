        ...
        <div class="container px-6 py-12 mx-auto">
            <div class="lg:flex lg:items-center lg:-mx-6">
                <div class="lg:w-1/2 lg:mx-6">
                    <h1
                        class="text-2xl font-semibold text-emerald-700 capitalize lg:text-3xl"
                    >
                        Contact us for <br />
                        more info
                    </h1>
                    ...
                    <div class="mt-6 space-y-8 md:mt-8">
                        <p class="flex items-start -mx-2">
                            <svg
                                ...
                                class="w-6 h-6 mx-2 text-emerald-500"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                                stroke-width="2"
                ...
                <div class="mt-8 lg:w-1/2 lg:mx-6">
                    <div class="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl lg:max-w-xl shadow-gray-300/50">
                        ...
                        <div class="w-full h-96">
                            <iframe 
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.5574759589087!2d107.5791413!3d-6.9425799!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e8c7a2f5d115%3A0x88b2e6e2929e78d5!2sSDN%20Warurejo!5e0!3m2!1sen!2sid!4v1701697436099!5m2!1sen!2sid"
                                width="100%" 
                                height="100%" 
                                style="border:0;" 
                                allowfullscreen="" 
