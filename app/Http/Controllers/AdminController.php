...
class AdminController extends Controller
{
    ...
    function editTentangSekolah(Tentangsekolah $id){
        return view('admin.editTentangSekolah', compact('id'));
    }

    function updateTentangSekolah(Request $request, string $id){
        $request->validate([
            'visi' => 'required',
            'misi' => 'required',
            'tujuan' => 'required'
        ...
        DB::table('tentangsekolahs')->where('id', $id)->update([
            'visi' => $request->visi,
            'misi' => $request->misi, 
